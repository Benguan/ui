NEG.Module("NEG.Widget.PropertyManager.Model", function (require) {
    ...
    var PropertyManager = function (config, option) {
        ...
        var getPropertyStatusAndResultInfo = function (properties) {
            ...
            //获取(n-1)C(n)的所有组合
            //possibeProperites:[{exclude:'尺寸',include:[{name:'颜色',value:'黄'},{name:'容量',value:'32GB'}]}]
        ...
        //当选中若干状态后，调用changeStatus([{name:'尺寸',value:'大'}，{name:'颜色',value:'黄'}])
        //返回对应的条件的所有info
        ...
        //构建内部数据结构,为每一中property构建一个其value，对应的所有的info的match关系
        (function () {
    ...
    //properties:[{name:'尺寸',value:['大','中','小']}，{name:'颜色',value:['黄','红','绿','蓝']},{name:'容量',value:['16GB','32GB','64GB']}0,
    //              {name:'订阅',value:["1": [6,12,24],"2": [8,12,36]]}]     ---[6,8,12,24,36]
