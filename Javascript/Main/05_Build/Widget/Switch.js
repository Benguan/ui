    ...
    function Switch(container,option){
        ...
        function bindTriggers(){
            var triggerCallback = function(e){
                        ...
                        _option.effect(_option.activeIndex,_option.contens);
                        _option.activeIndex = (_option.activeIndex+_option.step)%_option.contens.length;
...
*/
        ...
        var api = {
           ...
           ,switchTo : function(activeIndex){
               _option.activeIndex = activeIndex % _option.contens.length;
               _option.effect(activeIndex, _option.contens);
           }
